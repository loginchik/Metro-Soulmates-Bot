...
acc_create_conf_text = 'Ваш аккаунт успешно зарегистрирован. Чтобы посмотреть информацию вашего профиля, ' \
                       'воспользуйтесь функцией {0}'.format('/viewaccount')
...
do_not_delete_acc_text = 'Рад, что вы решили остаться. Аккаунт сохранен в базе пользователей'
delete_acc_confirm_ask_text = 'Вы уверены, что хотите удалить аккаунТ? (Да/нет)'
